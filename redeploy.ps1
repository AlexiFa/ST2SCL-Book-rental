...
$deployments = @("postgres-secret.yml", "postgres-storage.yml", "postgres-deployment.yml")  # Replace with your actual deployment names
$yamlFiles = @("postgres-deployment.yml", "postgres-storage.yml", "postgres-secret.yml")  # Replace with your actual YAML file paths
