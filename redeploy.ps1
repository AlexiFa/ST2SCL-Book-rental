...
$deployments = @("postgres-secret.yml", "postgres-storage.yml", "postgres-deployment.yml", "book-deployment.yml", "user-deployment.yml", "front-deployment.yml")  # Replace with your actual deployment names
$yamlFiles = @("front-deployment.yml", "user-deployment.yml", "postgres-deployment.yml", "postgres-storage.yml", "postgres-secret.yml", "book-deployment.yml")  # Replace with your actual YAML file paths
